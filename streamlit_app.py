...
def init_firebase():
    ...
    # Credentials are stored in Streamlit secrets as a JSON object
    # under [firebase_credentials] in secrets.toml.
    try:
        cred_dict = dict(st.secrets["firebase_credentials"])
        cred = credentials.Certificate(cred_dict)
    except Exception:
        # Fallback: read from a local service-account file for local dev.
